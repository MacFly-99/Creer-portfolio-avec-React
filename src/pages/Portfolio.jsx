...
function Portfolio() {
  return (
    <section className="py-5">
      ...
      {/* Section titre + cartes sur fond blanc */}
      <div className="py-5 bg-white">
        <Container>
          ...
          <Row className="g-4">
            {/* Projet 1 - Fresh Food */}
            <Col md={6} lg={4}>
              <Card className="h-100 border-0 shadow-lg portfolio-card text-center">
                <Card.Img
                  variant="top"
                ...
                <Card.Body className="p-4">
                  ...
                  <Button variant="primary" className="px-5 py-2 rounded portfolio-btn">
                    Voir le site
                  </Button>
            ...
            {/* Projet 6 - Maquette d'un site web */}
            <Col md={6} lg={4}>
              <Card className="h-100 border-0 shadow-lg portfolio-card text-center">
                <Card.Img
                  variant="top"
